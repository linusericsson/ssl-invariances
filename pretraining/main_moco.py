...
parser.add_argument('--model', default='default', help='which model to train, i.e. which augmentation to use (default/ventral/dorsal)')
...
def main():
    ...
    if args.model == 'default':
        args.augmentations = ['resized_crop', 'color_jitter', 'grayscale', 'blur', 'h_flip']
    elif args.model == 'ventral':
        args.augmentations = ['resized_crop', 'h_flip']
    elif args.model == 'dorsal':
        args.augmentations = ['color_jitter', 'grayscale', 'blur']
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best=False, filename='{0}_{1:04d}.pth.tar'.format(args.model + '_w3' if 'w3' in args.arch else '', epoch))
